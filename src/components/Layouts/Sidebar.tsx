                ...
                <div className="bg-white dark:bg-black h-full">
                    <div className="flex justify-between items-center px-4 py-3">
                        <NavLink to="/" className="main-logo flex items-center shrink-0">
                            ...
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5 font-semibold align-middle lg:inline dark:text-white-light">{t('SALOON CRM')}</span>
                        </NavLink>
                    ...
                    <PerfectScrollbar className="h-[calc(100vh-80px)] relative">
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/home" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3 text-neutral-300">{t('dashboard')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                            ...
                            <li className="menu nav-item">
                                <NavLink to="/location" className="group">
                                    <div className="flex items-center">
                                        <svg className="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                opacity="0.5"
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-neutral-300">{t('Location')}</span>
                                    </div>
                                </NavLink>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <NavLink to="/categories" className="group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-neutral-300">{t('Categories')}</span>
                                    </div>
                                </NavLink>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <NavLink to="/products" className="group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-neutral-300">{t('Products')}</span>
                                    </div>
                                </NavLink>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <NavLink to="/services" className="group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-neutral-300">{t('Services')}</span>
                                    </div>
                                </NavLink>
                            </li>

                            <li className="menu nav-item">
                                <NavLink to="/coupon" className="group">
                                    <div className="flex items-center">
                                        <svg className="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                opacity="0.5"
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-neutral-300">{t('Coupons')}</span>
                                    </div>
                                </NavLink>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <NavLink to="/employee" className="group">
                                    <div className="flex items-center">
                                        <svg className="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                opacity="0.5"
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-neutral-300">{t('Employee')}</span>
                                    </div>
                                </NavLink>
                            </li>

                            <li className="menu nav-item">
                                <NavLink to="/customer" className="group">
                                    <div className="flex items-center">
                                        <svg className="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                opacity="0.5"
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-neutral-300">{t('Customers')}</span>
                                    </div>
                                </NavLink>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <NavLink to="/bookings" className="group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-neutral-300">{t('Bookings')}</span>
                                    </div>
                                </NavLink>
                            </li>

                            <li className="menu nav-item">
                                <NavLink to="/bookingcalender" className="group">
                                    <div className="flex items-center">
                                        <svg className="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                opacity="0.5"
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-neutral-300">{t('Bookings Calender')}</span>
                                    </div>
                                </NavLink>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <NavLink to="/settings" className="nav-link group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-neutral-300">{t('General Settings')}</span>
                                    </div>
                                </NavLink>
                            </li>
                        </ul>
