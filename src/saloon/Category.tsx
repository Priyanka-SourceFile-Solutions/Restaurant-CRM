...
const Category = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Location'));
    });
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                ...
                <div className="flex sm:flex-row flex-col sm:items-center sm:gap-3 gap-4 w-full sm:w-auto">
                    ...
                    <div className="relative">
                        <input type="text" placeholder="Search Categories" className="form-input py-2 ltr:pr-11 rtl:pl-11 peer" value={search} onChange={(e) => setSearch(e.target.value)} />
