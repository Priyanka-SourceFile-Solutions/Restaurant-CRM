                                    ...
                                    <div className="p-5">
                                        <form>
                                            ...
                                            <div className="mb-5">
                                                ...
                                                <input id="location" type="text" className="form-input" value={params.location} onChange={(e) => changeValue(e)} />
                                            </div>
                                            <div className="mb-5">
                                                <label htmlFor="email">Image</label>
                                                <img id="location" className="form-input" src={params.img} onChange={(e) => changeValue(e)} />
                                            </div>
