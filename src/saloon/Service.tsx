            ...
            <button type="button" className={`btn btn-outline-primary p-2 ${value === 'grid' && 'bg-primary text-white'}`} onClick={() => setValue('grid')}>
                <IconLayoutGrid />
                    ...
                    <div className="relative">
                        <input type="text" placeholder="Search Products" className="form-input py-2 ltr:pr-11 rtl:pl-11 peer" value={search} onChange={(e) => setSearch(e.target.value)} />
                                        ...
                                        <tr key={contact.id}>
                                            {/* <td>
                                                <div className="flex items-center w-max">
                                                    {contact.path && (
                                                        <div className="w-max">
                                                            <img src={`/assets/images/${contact.path}`} className="h-20 w-20 object-cover" alt="avatar" />
                                                        </div>
                                                    )}
                                                </div>
                                            </td> */}
                                            ...
                                            <td className="whitespace-nowrap">{contact.mrp}</td>
                                            <td className="whitespace-nowrap">{contact.price}</td>
                                            <td className="whitespace-nowrap">{contact.location}</td>
                                            <td className="whitespace-nowrap">{contact.time}</td>

                                            <td className="whitespace-nowrap">
                                                {contact.status ? <span className="badge bg-success">Active</span> : <span className="badge bg-danger">Blocked</span>}
                                            </td>
                                            <td>
                ...
                <Dialog as="div" open={addContactModal} onClose={() => setAddContactModal(false)} className="relative z-[51]">
                    ...
                    <div className="fixed inset-0 overflow-y-auto">
                        <div className="flex min-h-full items-center justify-center px-4 py-8">
                            ...
                            >
                                <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-[870px] text-black dark:text-white-dark">
                                    <button
                                        type="button"
                                    ...
                                    <div className="text-lg font-medium bg-[#fbfbfb] dark:bg-[#121c2c] ltr:pl-5 rtl:pr-5 py-3 ltr:pr-[50px] rtl:pl-[50px]">
                                        {params.id ? 'Edit Services' : 'Add Services'}
                                    </div>
                                    ...
                                    <div className="p-5">
                                        <form className="space-y-5">
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                                                <div>
                                                    <label htmlFor="browserFname">Service Name</label>
                                                    <input id="browserFname" type="text" placeholder="Enter Service Name" className="form-input" required />
                                                </div>
                                                <div>
                                                    <label htmlFor="browserLname">Price</label>
                                                    <input id="browserLname" type="text" placeholder="Enter Price" className="form-input" required />
                                                </div>
                                                <div>
                                                    <label htmlFor="browserLname">Discount</label>
                                                    <input id="browserLname" type="text" placeholder="Enter Discount" className="form-input" required />
                                                </div>
                                            </div>
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                                                <div>
                                                    <label htmlFor="browserFname">Location</label>
                                                    <input id="browserFname" type="text" placeholder="Enter Location" className="form-input" required />
                                                </div>
                                                <div>
                                                    <label htmlFor="browserLname">Description</label>
                                                    <textarea id="browserLname" className="form-input" required />
                                                </div>
                                            </div>
